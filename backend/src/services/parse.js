...
const BANK_MAP = [
  ...
  // กระเป๋าเงินอิเล็กทรอนิกส์ — จับก่อน "พร้อมเพย์" เพราะสลิปเป๋าตัง/โครงการรัฐมักโอนผ่านพร้อมเพย์
  // แต่ผู้ใช้อยากเห็นชื่อแอปจริง (เป๋าตัง) ไม่ใช่ช่องทางโอน
  [/เป๋าตัง|paotang|g-?wallet|ไทยช่วยไทย|คนละครึ่ง|เที่ยวด้วยกัน/i, 'เป๋าตัง'],
  [/ทรูมันนี่|truemoney|true\s?money|wallet by truemoney/i, 'ทรูมันนี่'],
